...
public class Compra_cre{
	...
	public Compra_cre(Integer id){
		this.id = id;
	}
	@Override
	public String toString() {
		return "Compra_cre{"+", com_nro=" + com_nro+", com_codpro=" + com_codpro+", com_cant=" + com_cant+", cod_tipcan=" + cod_tipcan+", com_costo=" + com_costo+", com_pventa1=" + com_pventa1+", com_pventa2=" + com_pventa2+", com_pventa3=" + com_pventa3+", com_pventa4=" + com_pventa4+", com_vencimiento=" + com_vencimiento+", com_activo=" + com_activo+", com_stact=" + com_stact+", com_stant=" + com_stant+", com_iva=" + com_iva+", com_iva5=" + com_iva5+", com_iva10=" + com_iva10+", com_excen=" + com_excen+", com_lote=" + com_lote+", com_moneda=" + com_moneda+", com_monedo=" + com_monedo+", com_monere=" + com_monere+", com_monepe=" + com_monepe+", com_moneeu=" + com_moneeu+", com_nucaja=" + com_nucaja+", com_desc=" + com_desc+", com_borrado=" + com_borrado+", com_deposito=" + com_deposito+", com_costomayorista=" + com_costomayorista+", com_bonificado=" + com_bonificado+", com_id=" + com_id+", com_rubro=" + com_rubro+", com_detalle=" + com_detalle+"}";
