...
public class Arqcajageneral{
	...
	public Arqcajageneral(Integer arq_nro, Integer arq_usuario, String arq_numcaja, String arq_fecha, String arq_fechacarga, String arq_hora, Double arq_cajinicial, Double arq_totdescredito, Double arq_totvencontado, Double arq_totdescontado, Double arq_totchedia, Double arq_totnota, Double arq_tottarcredito, Double arq_comcrepagado, Double arq_tottardebito, Double arq_comcontado, Double arq_faccrecobrado, Double arq_totgasto, Double arq_totvencredito, Double arq_totingreso, Double arq_totegreso, Double arq_efecaja, Integer arq_borrado, Double arq_totcheplazo, Double arq_totefecajguarani, Double arq_totefecajdolar, Double arq_totefecajreal, Double arq_totefecajpeso, Double arq_totefecajeuro, Double arq_tototrosingresos, Double arq_totentregacobrada, Double arq_totcuotacobrada, Double arq_totnotaemitida, Double arq_totsalon, Double arq_totgreenfee, Double arq_totcarrito, Double arq_totpiscina, Double arq_totocupacion, Double arq_totconsumicion, Double arq_totgiro, Double arq_totdepbancario, Double arq_tototrasentradas, Double arq_totaladelanto, Double arq_totalsalario, Double arq_totinguarani, Double arq_totindolar, Double arq_totinreal, Double arq_totinpeso, Double arq_totineuro, Double arq_totdifguarani, Double arq_totdifdolar, Double arq_totdifreal, Double arq_totdifpeso, Double arq_totdifeuro){
